LOAF.ListSingleItemView = Backbone.View.extend
  ...
  events:
    "mouseover .bcrumbs-hover-link-info": "onShowInfo"
    "mouseover .bcrumbs-hover-link-plus": "onShowAdd"
    "mouseover .bcrumbs-hover-link-edit": "onShowEdit"
    "mouseover .bcrumbs-hover-link-list": "onShowLists"
    "mouseover .bcrumbs-hover-link-star": "onShowReviews"
    "click .bcrumbs-hover-link-info": "onClickInfo"
    "click .bcrumbs-hover-link-plus": "onClickAdd"
    "click .icon-ok": "onClickRemove"
    "click .bcrumbs-hover-link-edit": "onClickEdit"
    "click .bcrumbs-hover-link-list": "onClickLists"
    "click .bcrumbs-hover-link-star": "onClickReviews"
